...
- **pi-tmux-subagents** — delegate bounded work to observable Pi sessions running in tmux.
...
The `pi-tmux-subagents` skill requires Bash, tmux, Pi available as `pi`, and Git for worktree mode.
